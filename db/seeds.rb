...
minions = Video.create!(title: "Minions", description: "Banana!", year: 2015, maturity_rating: "PG", runtime: "1h 31m", video_type: "Movie")
minions.video_url.attach(io: open('https://tomflix-seeds.s3.amazonaws.com/minions.mp4'), filename: 'minions.mp4')
minions.photo.attach(io: open('https://tomflix-seeds.s3.amazonaws.com/minions.jpg'), filename: 'minions.jpg')
...
moviesVidGenre4 = VideoGenre.create(video_id: guardiansofthegalaxy.id, genre_id: movies.id)
moviesVidGenre5 = VideoGenre.create(video_id: exmachina.id, genre_id: movies.id)
moviesVidGenre6 = VideoGenre.create(video_id: thematrix.id, genre_id: movies.id)
moviesVidGenre7 = VideoGenre.create(video_id: jumpstreet.id, genre_id: movies.id)
moviesVidGenre8 = VideoGenre.create(video_id: theinterview.id, genre_id: movies.id)
moviesVidGenre9 = VideoGenre.create(video_id: ratatouille.id, genre_id: movies.id)
moviesVidGenre10 = VideoGenre.create(video_id: nemo.id, genre_id: movies.id)
# moviesVidGenre11 = VideoGenre.create(video_id: wreckitralph.id, genre_id: movies.id)
moviesVidGenre11 = VideoGenre.create(video_id: minions.id, genre_id: movies.id)
...
moviesVidGenre19 = VideoGenre.create(video_id: wolfofwallstreet.id, genre_id: movies.id)
moviesVidGenre20 = VideoGenre.create(video_id: fightclub.id, genre_id: movies.id)

tvshowsVidGenre1 = VideoGenre.create(video_id: theoffice.id, genre_id: tvshows.id)
...
list2 = MyList.create(user_id: testUser.id, video_id: guardiansofthegalaxy.id)
list3 = MyList.create(user_id: testUser.id, video_id: monstersinc.id)
list4 = MyList.create(user_id: testUser.id, video_id: lalaland.id)
list5 = MyList.create(user_id: testUser.id, video_id: community.id)
list6 = MyList.create(user_id: testUser.id, video_id: himym.id)
list7 = MyList.create(user_id: testUser.id, video_id: theinterview.id)