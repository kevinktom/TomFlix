            ...
            <div className='indexGrid'>
                ...
                {videos.length > 0 ?
                    <div className="mainVideoDiv">
                        {/* autoPlay loop */}
                        <video muted={false} className="mainVideo" id="mainvid"  > <source src={videos[0].video_url} type="video/mp4" /> </video>
                        ...
                        <div className="rowsection">
                            ...
                            <div className='blockrow'>
                                <div onClick={() => this.props.history.push(`/browse/${videos[2].id}`)} className='videodivfirst'>
                                ...
                                {/* <div onClick= { () => this.props.history.push(`/browse/${videos[1].id}`)} className='videodiv'>
              ...
              <div onClick= { () => this.props.history.push(`/browse/${videos[5].id}`)} className='videodivlast'>
                ...
                <div className="middlebottomhalf">
                    <div className="secondsection">
                        ...
                        <div className='blockrow2'>
                            ...
                            {/* <div onClick={() => this.props.history.push(`/browse/${videos[7].id}`)} className='videodiv'>
                            ...
                            <div onClick={() => this.props.history.push(`/browse/${videos[8].id}`)} className='videodiv'>
                            ...
                            <div onClick={() => this.props.history.push(`/browse/${videos[10].id}`)} className='videodiv'>
                                <video className="rowvideo" poster={videos[10].photo_url} onMouseOver={this.handleHoverPlay} onMouseLeave={this.handleHoverLeave}> <source src={videos[10].video_url} type="video/mp4" /> </video>
                            </div>

                            <div onClick={() => this.props.history.push(`/browse/${videos[11].id}`)} className='videodivlast'>
                        ...
                        <div className="secondsection">
                            ...
                            <div className='blockrow2'>
              <div onClick={() => this.props.history.push(`/browse/${videos[3].id}`)} className='videodivfirst'>
                <video className="rowvideo" poster={videos[3].photo_url} onMouseOver={this.handleHoverPlay} onMouseLeave={this.handleHoverLeave}> <source src={videos[3].video_url} type="video/mp4" /> </video>
              </div>
              ...
              <div onClick={() => this.props.history.push(`/browse/${videos[22].id}`)} className='videodiv'>
                <video className="rowvideo" poster={videos[22].photo_url} onMouseOver={this.handleHoverPlay} onMouseLeave={this.handleHoverLeave}> <source src={videos[22].video_url} type="video/mp4" /> </video>
              </div>

              <div onClick={() => this.props.history.push(`/browse/${videos[21].id}`)} className='videodiv'>
                <video className="rowvideo" poster={videos[21].photo_url} onMouseOver={this.handleHoverPlay} onMouseLeave={this.handleHoverLeave}> <source src={videos[21].video_url} type="video/mp4" /> </video>
              </div>

              <div onClick={() => this.props.history.push(`/browse/${videos[20].id}`)} className='videodiv'>
                <video className="rowvideo" poster={videos[20].photo_url} onMouseOver={this.handleHoverPlay} onMouseLeave={this.handleHoverLeave}> <source src={videos[20].video_url} type="video/mp4" /> </video>
              </div>

              <div onClick={() => this.props.history.push(`/browse/${videos[23].id}`)} className='videodivlast'>
                <video className="rowvideo" poster={videos[23].photo_url} onMouseOver={this.handleHoverPlay} onMouseLeave={this.handleHoverLeave}> <source src={videos[23].video_url} type="video/mp4" /> </video>
              </div> */}
            </div>
                        </div>
                        ...
                        <div className="secondsection">
                            ...
                            {/* <div className='blockrow2'>
              <div onClick={() => this.props.history.push(`/browse/${videos[12].id}`)} className='videodivfirst'>
              ...
              <div onClick={() => this.props.history.push(`/browse/${videos[17].id}`)} className='videodivlast'>
                ...
                {/* {videos.length >= 1 ?
          <div>
      <video controls className='testvid' > <source src={videos[0].video_url} type="video/mp4" /> </video> 
          </div> : <div className='mainBackground'> </div>} */}
